...
if st.button(current_texts["analyze"], key="calculate_btn"):
    ...
    if impossible_count > 0:
        ...
        final_advice = (
            ...
            f'⚠️ يمكنك الدخول للوزاري ولكن عليك التركيز بشكل كبير على المواد التي تحتاج إلى تحسين.'
            f'<br>لديك {improvement_count} مواد تحتاج إلى تحسين، وهذا عدد معقول يمكن تحسينه بالدراسة الجيدة.'
            '</div>'
        )
    else:
        final_advice = (
            '<div class="advice-item danger final-advice">'
            f'⚠️ الدخول للوزاري في هذه الحالة محفوف بالمخاطر.'
            f'<br>لديك {improvement_count} مواد تحتاج إلى تحسين، وهذا عدد كبير. ننصحك بالتفكير جيداً والتشاور مع الأهل والمدرسين.'
            '</div>'
        )
